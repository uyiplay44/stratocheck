...
app.config['MAIL_USERNAME'] = 'haydencdric@gmail.com'  # Your Gmail email address
app.config['MAIL_PASSWORD'] = 'sdoaiyslmdjtgotc'# Your Gmail password or App Password
...
def login():
    ...
    return redirect('https://stratocheck-kappa.vercel.app/')
